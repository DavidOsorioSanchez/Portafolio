...
function ComponenteTarjeta ({children, retrazo, imagenTarjeta, titulo, tipo}){

    return(
        <div className={`w-2/5 min-w-72 max-h-max h-96 rounded-lg animate-bajada ${retrazo} object-cover bg-no-repeat bg-cover bg-total  ${imagenTarjeta}`}>
