...
function Footer() {
  return (
    <footer className="!w-full h-auto flex flex-col  min-h-24 bg-colorFooter border-solid border-t-2 border-colorBordePerfil gap-20 py-12">
      <p className="text-center text-5xl text-blancoEstrella">Formulario</p>
      <form className="w-full flex gap-5 flex-wrap justify-around">
        <input
